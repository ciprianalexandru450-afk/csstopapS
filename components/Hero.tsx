      ...
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            <div className="mt-10">
              <a href="#rezervari" className="inline-block bg-gradient-to-r from-[#c0a062] to-[#d4b47a] text-black font-bold py-4 px-10 rounded-md shadow-lg hover:scale-105 transition-transform">
                {t.button}
              </a>
            </div>
          </div>
          <div className="relative flex items-center justify-center min-h-[300px] md:min-h-[400px]">
            {/* Spotlight effect */}
            <div className="absolute inset-0 rounded-lg bg-[radial-gradient(ellipse_at_center,_rgba(192,160,98,0.15)_0%,_rgba(17,24,39,0)_70%)]"></div>
            ...
            <div className="relative z-10 flex flex-col items-end w-full">
                ...
                <img 
                    ...
                    className="w-full h-auto object-contain drop-shadow-2xl mt-0 md:-mt-16"
                />
            </div>
          </div>
        </div>
        <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          <FeatureCard 
            icon={<ClockIcon className="w-10 h-10 text-[#c0a062]" />} 
            title={t.feature1Title}
            description={t.feature1Desc}
          />
          <FeatureCard 
            icon={<ShieldIcon className="w-10 h-10 text-[#c0a062]" />} 
            title={t.feature2Title}
            description={t.feature2Desc}
          />
          <FeatureCard 
            icon={<DiamondIcon className="w-10 h-10 text-[#c0a062]" />} 
            title={t.feature3Title}
            description={t.feature3Desc}
          />
        </div>

        <div id="servicii" className="mt-32 scroll-mt-[100px]">
          <p className="text-center max-w-4xl mx-auto text-xl text-gray-300 leading-relaxed">
            {t.servicesIntro}
          </p>
          ...
          <div className="mt-16 w-full">
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10">
              ...
              />
              <ServiceCard
                icon={<MoreHorizontalIcon className="w-12 h-12" />}
